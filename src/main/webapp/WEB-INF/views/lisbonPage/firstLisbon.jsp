                                    ...
                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="../../../resources/img/L1.jpg" height="600" width="600"
                                                     class="d-block w-100" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="../../../resources/img/L2.jpg" height="600"
                                                     width="600"
                                                     class="d-block w-100" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="../../../resources/img/L3.jpg" height="600"
                                                     width="600"
                                                     class="d-block w-100" alt="...">
                                            </div>
                                ...
                                <div class="col-6"><h1 style="font-weight: bold; font-size: 30px;">🏹리스본의 오랜 역사 속으로 빠지는
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-9" style="font-size: 21px;">
                                                리스본의 고대 역사와, 그 안에 숨겨진 종교적 의미에 대해 탐구해보는 5박 6일 패키지여행 상품입니다.
                                            </div>
                                            <p></p>
                                            <div class="col-3" style="font-size: 21px;">
                                                <li>여행 지역</li>
