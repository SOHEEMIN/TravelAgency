    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-5 col-md-8 mx-auto">
                ...
                <p class="lead text-muted" style="font-family: 'IM_Hyemin-Bold'; font-size: 24px;"><br>이벤트 등록<br></p>
                <form action="/event/save" method="post" enctype="multipart/form-data">
                    <div align="center"
                        ...
                        <div>
                            <label>설명</label>
                            <input type="textarea" name="eventContents">
                        </div>
                        <div>
                            <label>가격</label>
                            <input type="text" name="eventPrice">
                        </div>
                        <div>
                            <label>재고</label>
                            <input type="text" name="eventStock">
                        </div>
                        <div>
                            <label>이벤트 사진</label>
