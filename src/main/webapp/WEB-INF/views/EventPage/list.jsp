    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-10 col-md-8 mx-auto">
                ...
                <p class="lead text-muted" style="font-family: 'IM_Hyemin-Bold'; font-size: 24px;"><br>이벤트<br></p>
                <div style="background-color: #f9f2f9; padding:20px; font-family:'IM_Hyemin-Bold'; font-size: 22px; border-radius: 20px;">
                    <br>
                    <div class="container">
                        <div class="row row-cols-3">
                            <c:forEach var="event" items="${eventList}">
                                <div class="col">
                                    <a href="${pageContext.request.contextPath}/event/detail?id=${event.id}"><img
                                            src="/upload/${event.eventImageName}" height="100" width="100" alt=".."></a>

<%--                                    <img src="/upload/product/${product.productImageName}" alt="..">--%>

                                    <h5 class="card-title">${event.eventName}</h5>
                                    <p class="card-text">${event.eventContents}</p>
                                    <li>Event no: ${event.id}</li>
                                    <li>price: ${event.eventPrice}원</li>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
