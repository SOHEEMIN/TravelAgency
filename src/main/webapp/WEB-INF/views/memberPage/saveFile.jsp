    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p class="lead text-muted" style="font-family: 'IM_Hyemin-Bold'; font-size: 22px;"><br>회원가입<br></p>
                <div class="col col-lg-12">
                    <div id="wrap">
                        <form action="/member/saveFile" method="post" enctype="multipart/form-data">
                            <div align="left"
                                 style="background-color: #f9f2f9; padding:20px; font-family:'IM_Hyemin-Bold'; font-size: 18px; border-radius: 20px;">
                                <br>
                                아이디<br>
                                ...
                                <br><br>
                                이메일<br><input type="text" id="memberEmail" name="memberEmail" onblur="userCheck()"> @
                                <input type="text" id="userEmail">
                                <select id="id1" onchange="idSelect()">
...
<script>
    ...
    function idSelect() {
        ...
        console.log(`선택한 이메일: ${id1}`);
        document.getElementById("userEmail").value = id1;
    }
    ...
    function userCheck() {
        ...
        if (userid.length == 0) {
            selectResult.innerHTML = "필수입력입니다."
        }
    }
</script>
</html>
