                ...
                <form action="/board/saveFile" method="post" enctype="multipart/form-data">
                    <div align="left"
                        ...
                        <input class="form-control mb-2" type="text" name="memberId" value="${sessionScope.loginMemberId}"
                               readonly><br>
                        제목<br>
                        <input class="form-control mb-2" type="text" name="itemTitle" placeholder="제목"><br>
                        내용<br>
                        <textarea class="form-control mb-2" name="itemContents" rows="10" cols="50"></textarea><br>
